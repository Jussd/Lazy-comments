...
class ModelWindow:
    ...
    def _del(self, mid):
        ...
        if not messagebox.askyesno("Delete?","Delete model files for '"+MODELS[mid]["name"]+"'?"); return
    ...
    def _settings_window(self):
        ...
        # API Key
        kf = tk.LabelFrame(win, text="Google Cloud API Key", padx=12, pady=8)
        ...
        tk.Label(kf, text="Get key: console.cloud.google.com - APIs & Services - Credentials",
