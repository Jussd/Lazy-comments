...
a = Analysis(
    ...
    hiddenimports=[
        'sherpa_onnx',
        'lazy_comments', 'lazy_comments.config', 'lazy_comments.terms',
        'lazy_comments.terms.it_ru', 'lazy_comments.terms.it_de',
        'lazy_comments.terms.it_es', 'lazy_comments.terms.it_fr',
        'lazy_comments.terms.it_cn',
        'lazy_comments.terms.crypto_ru', 'lazy_comments.terms.crypto_de',
        'lazy_comments.terms.crypto_es', 'lazy_comments.terms.crypto_fr',
        'lazy_comments.terms.crypto_cn',
        'lazy_comments.punctuation',
